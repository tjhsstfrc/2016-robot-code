...
//    final int rearRightChannel	= 1;
    ...
    public Robot() {
        ...
        awesome = new DoubleSolenoid(1, 0);
    ...
    public void operatorControl() {
    	...
    	if(rightStick.getRawButton(3)){
 	       ...
 	       awesome.set(DoubleSolenoid.Value.kForward);		// Pneumatic system:
    	}
    	else if(rightStick.getRawButton(4)){
 	    	System.out.println("button 4");
 	       awesome.set(DoubleSolenoid.Value.kReverse);
 	    }
    	else{
    		awesome.set(DoubleSolenoid.Value.kOff);		// Pneumatic system: turn OFF
    	}
